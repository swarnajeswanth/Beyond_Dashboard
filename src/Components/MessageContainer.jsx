  ...
  return (
    <div className="messages-container">
      {Object.keys(chatSelected).length === 0 ? (
        ...
        <>
          <div ref={messageHeaderRef}>
            <div className="message-header">
              {loading ? <MessageHeader /> : <p>{chatSelected.full_name}</p>}

              <div className="message-feature-icons">
                <span>
          ...
          <div className="messages">
            {loading ? (
              ...
              <>
                {/* left message */}
                <div className="rsingle-msg ">
                  <div>
                    <img
                      src={`${
                        chatSelected.profile_img ||
          ...
          <div className="message-chat-container">
            <div>
              <div className="message-chat-header">
                <BsChatLeftText /> <span>Chat</span>
              </div>
              <div className="message-chat-shortcut">
                Use ctrl + k for shortcuts
              </div>
            </div>
            <div className="message-chat-icons">
              <div>
                <span>
                  <IoFlash />
                  <hr />
              ...
              <div>
                ...
                <span>
                  <button>Send</button> <IoIosArrowDown />
                </span>
              </div>
            </div>
          </div>
